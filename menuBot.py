...
# -----------------------------------------------------------------------
m_main2 = Menu("Главное меню", buttons=["В мире животных🦊🐾🦮", "Игры", "ДЗ", "Музыка🎵", "Погода🌧", "Лабиринт", "Помощь🙏"])
m_games = Menu("Игры", buttons=["Игра КНБ", "Игра в 21", "Выход"], module="botGames", parent=m_main2)
...
m_cats = Menu("В мире животных🦊🐾🦮", buttons=["Лиса для хорошего настроения)", "Факты о котиках", "Факты о собаках", "Факты о лисичках", "Породы кошек",  "Выход"], parent=m_main2, module="cats")
#m_film = Menu("Фильм", buttons=["Прислать фильм", "Билеты на сегодня", "Выход"], parent=m_main2, module="film")
m_music = Menu("Музыка🎵", buttons=["Ssshhhiiittt!!!", "Нервы", "Кис-Кис", "Выход"], parent=m_main2, module="music")
